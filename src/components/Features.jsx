...
const BentoCard = ({ src, title, description, isComingSoon}) => {
  return (
    <div className="relative size-full">
      ...
      <div className="relative z-10 flex size-full flex-col junstify-between p-5 text-blue-50">
        <div>
    ...
    <section className="bg-black pb-52">
      ...
      <div className="grid h-[135vh] grid-cols-2 grid-rows-3 gap-7">
        ...
        <BentoTilt className="bento-tilt_1 row-span-1 ms-32 md:col-span-1 md:ms-0">
          <BentoCard src="videos/feature-3.mp4" title={<>n<b>e</b>xus</>} description="A gamified social hub, adding a new dimension of play to social interaction for Web3 communities."></BentoCard>
        </BentoTilt>

        <BentoTilt className="bento-tilt_1 me-14 md:col-span-1 md:me-0">
          <BentoCard src="videos/feature-4.mp4" title={<>az<b>u</b>re</>} description="A cross-world AI Agent - elevating your gameplay to be more fun and productive."></BentoCard>
        </BentoTilt>
