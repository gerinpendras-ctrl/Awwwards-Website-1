      ...
      <header className="absolute top-1/2 w-full -translate-y-1/2">
        <nav className="flex size-full items-center justify-between p-4">
          <div className="flex items-center gap-7">
            ...
            <a href="https://gerinpendras.site" target="_blank">
              <Button id="product-button" title="My official website" rightIcon={<TiLocationArrow/>} containerClass="bg-blue-50 md:flex hidden items-center justify-center gap-1" />
            </a>
          </div>
